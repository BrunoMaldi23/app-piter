...
import { INFO_CATEGORIAS, imagenFallback } from '../data/productos';
...
export default function SeccionForm({
  ...
  const guardar = () => {
    ...
    onGuardar({
      nombre: nombre.trim(),
      emoji: emoji.trim() || '🛍️',
      imagen: imagen.trim() || imagenFallback,
      categoria,
    });
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TextInput
          className="mb-2 h-12 rounded-xl border border-neutral-200 bg-neutral-50 px-4 text-[15px] text-neutral-900"
          placeholder="https://imagen-de-la-seccion.jpg"
          placeholderTextColor="#a3a3a3"
          keyboardType="url"
          autoCapitalize="none"
          autoCorrect={false}
        ...
        <Text className="mb-4 text-xs text-neutral-400">
          Deja vacío para usar una imagen genérica.
        </Text>
